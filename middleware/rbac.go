...
func RBAC(permissionService service.IPermissionService, permissionName string) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		allowed, err := permissionService.HasPermissionByName(ctx, roleID, permissionName)
		if err != nil {
