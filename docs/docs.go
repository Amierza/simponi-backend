...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Simponi Support",
            "email": "support@simponi.app"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.RefreshTokenResponseWrapper"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.SignInResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request - Invalid payload",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ImpersonateSuccessResponse"
                        }
                    },
                    "400": {
        ...
        "/permissions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Enable pagination (true/false), default: true",
                        "name": "pagination",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Page number (if pagination=true)",
                        "name": "page",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Items per page (if pagination=true)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Success (without pagination)",
                        "schema": {
                            "$ref": "#/definitions/dto.PermissionResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.RolesResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.RoleResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.StoresResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.StoreResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/stores/{store_id}/external-products": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ExternalProductsSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateExternalProductRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.ExternalProductCreateSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/stores/{store_id}/external-products/store-platform/{store_platform_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/stores/{store_id}/external-products/{external_product_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ExternalProductSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateExternalProductRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ExternalProductUpdateSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ExternalProductDeleteSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.ProductsResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Invalid UUID",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.ProductResponseWrapper"
                        }
                    },
                    "400": {
                    ...
                    "409": {
                        "description": "Conflict (SKU duplicate)",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    },
        ...
        "/stores/{store_id}/products/stats": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.ProductStatsResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Invalid UUID",
        ...
        "/stores/{store_id}/products/{product_id}/stock": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.StoreUsersResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Invalid UUID",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateStoreUsersRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.StoreUserResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Invalid UUID",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.UploadSuccessMultipleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/dto.UsersResponseWrapper"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.DashboardResponse": {
            "type": "object",
            "properties": {
                "new_stores_last_7_days": {
                    "type": "integer"
                },
                "total_connected_shopee": {
                    "type": "integer"
                },
                "total_connected_tiktok_shop": {
                    "type": "integer"
                },
                "total_stores": {
                    "type": "integer"
        ...
        "dto.ExternalProductCreateSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.ExternalProductResponse"
                },
                "message": {
                    "type": "string",
                    "example": "success create external product"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.ExternalProductDeleteSuccessResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "success delete external product"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.ExternalProductSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.ExternalProductResponse"
                ...
                "message": {
                    "type": "string",
                    "example": "success get external product"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.ExternalProductUpdateSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.ExternalProductResponse"
                ...
                "message": {
                    "type": "string",
                    "example": "success update external product"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.ExternalProductsSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                ...
                "message": {
                    "type": "string",
                    "example": "success get external products"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.ImpersonateSuccessResponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "dto.PermissionPaginationResponseWrapper": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "success get permissions"
                },
                "meta": {},
                "status": {
                    "type": "boolean",
        ...
        "dto.ProductListResponse": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "\"Mapped\", \"Unmapped\", \"Low Stock\", \"Out of Stock\"",
                    "type": "string"
                },
                "stock": {
                    "type": "integer"
        ...
        "dto.ProductStatsResponseWrapper": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.ProductStatsResponse"
                },
                "message": {
                    "type": "string",
                    "example": "success get product stats"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.RefreshTokenResponseWrapper": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "dto.StoreResponse": {
            ...
            "properties": {
                ...
                "platforms": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PlatformResponse"
                    }
                }
            }
        },
        "dto.StoreResponseWrapper": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "dto.StoreUserResponseWrapper": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.CustomUserResponse"
                },
                "message": {
                    "type": "string",
                    "example": "success get store user"
                },
                "status": {
                    "type": "boolean",
                    "example": true
        ...
        "dto.StoreUsersResponseWrapper": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "success get store users"
                },
                "meta": {},
                "status": {
                    "type": "boolean",
        ...
        "dto.UpdateExternalProductRequest": {
            "type": "object",
            "required": [
                "price"
            ],
        ...
        "dto.UploadSuccessMultipleResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
    ...
    "tags": [
        {
            "description": "Authentication (signin, refresh token) and token management",
            "name": "Auth"
        },
        {
        ...
        {
            "description": "Store management and store-related operations",
            "name": "Stores"
        },
        {
        ...
        {
            "description": "External product integration (Shopee, Tokopedia, etc.)",
        ...
        {
            "description": "Inventory movement and stock change logs",
            "name": "Inventory Logs"
        },
        {
        ...
        {
            "description": "Admin impersonation for debugging and support",
            "name": "Impersonate"
        }
    ],
    "externalDocs": {
